...
export default function Listing() {
    ...
    return (
        <Layout
            isMobile={isMobile}
            header={<Header title="Inquires List" breadcrumb={breadcrumb} />} // Pass your Header component
            ...
            <div className="flex flex-col w-full">
                <main className='flex flex-1 flex-col p-4 md:gap-1 md:p-4 bg-white  dark:bg-gray-800 dark:text-white-800' >
                    ...
                    <Card className="w-full mb-5">
                        <CardHeader routeRedirect={routeRedirect} handleActions={handleActions} totalRecord={d2.length} />
